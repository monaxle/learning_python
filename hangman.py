def hangman():
    ...
    def picture():
        ...
        if noose == 1:
            ...
            print('____|____')
            x = ''.join(result)
            print('\nYOU\'RE DEAD!!! The word was', x.capitalize() + '.')
            wp = 'https://www.dictionary.com/browse/' + x
            webbrowser.open(wp)
            hangman()
    ...
    print('Well done! You got it!', display.capitalize(), 'was the word.')
    wp = 'https://www.dictionary.com/browse/' + display
    webbrowser.open(wp)
    hangman()
